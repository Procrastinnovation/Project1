...
<!--18SEP2014 JLim Initial release for Project 1. Bootstrap were used for additional CSS effect-->
<!DOCTYPE html>
<html>
<head>

	<title>John Lim P1 - DWA15 Portfolio</title>
	<meta charset="utf-8">
...
<div class="container">
<img class="img-circle" src='images/John_Lim_HeadShot.jpg' alt="John Lim image" style="width: 140px; height: 187px;">
<h1>John Lim <br> Dynamic Web Apps Portfolio</h1>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src='images/Projects2.jpg' alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img src='images/Projects3.jpg' alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img src='images/Projects4.jpg' alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>Project 4 Title</h1>
              <p>View: <code>[link]</code><br>Github:<code>[link]</code></p>
              <p><a class="btn btn-lg btn-primary" href="#" role="button">Project 4</a></p>
            </div>
          </div>
        </div>
      </div>
...
<h2>Why are you taking this course?</h2>
		...
		<p>On free time, I practice Taekwondo, gymnastic and many other outdoor sports. I also play acrostic and electric guitar.</p>

<!-- FOOTER -->
      <footer>
	<p>-Credits-</p>
	<p>Carousel &middot; <a href='http://hdw.eweb4.com/search/1920x1200+city/'  target="_blank")">>Images</a> Extra Challenge &middot; <a href='http://getbootstrap.com/'  target="_blank")">>BootStrap</a> </p>
